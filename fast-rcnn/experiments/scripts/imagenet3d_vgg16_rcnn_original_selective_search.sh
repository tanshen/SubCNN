...
LOG="experiments/logs/imagenet3d_vgg16_rcnn_original_selective_search.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu $1 \
  ...
  --net output/imagenet3d/imagenet3d_trainval/vgg16_fast_rcnn_original_imagenet3d_selective_search_iter_160000.caffemodel \
