...
LOG="experiments/logs/imagenet3d_vgg16_rcnn_view_edge_boxes.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
...
time ./tools/test_net.py --gpu $1 \
  ...
  --net output/imagenet3d/imagenet3d_trainval/vgg16_fast_rcnn_view_imagenet3d_edge_boxes_iter_160000.caffemodel \
